...
import { getAvailableSubtitle, getCreateVideo, getShortClips, postShortClips } from "../../../redux/actions/createVideoAction";
...
const ShortVideo = () => {
    ...
    // useEffect(() => {
    //     const ENDPOINT = "https://app.clatter.ai"
    //     const socket = io(ENDPOINT);
    //     socket.on('connection', () => {
    //         console.log('Connected to the server');
    //     });
    //     socket.emit('getVideo', "hello backend from frontend user");
